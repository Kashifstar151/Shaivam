...
export const onRegionChangeCompleteCallback = (args, clbk) => {
    console.log("the args from the onRegionChangeCallback ", args)
    clbk(args)
}
...
export const getTheLocationName = async (coords) => {
    ...
    */
    ...
    const data = await fetch(`https://nominatim.openstreetmap.org/reverse?format=jsonv2&lat=${coords.latitude}&lon=${coords.longitude}`, {
        method: "GET",
        headers: new Headers({
