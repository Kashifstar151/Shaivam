...
const ConstantHeader = () => {
    return (
        <View style={{ paddingTop: Platform.OS == 'ios' ? StatusBar.currentHeight + 40 : 20, paddingHorizontal: 15, paddingBottom: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            <View>
