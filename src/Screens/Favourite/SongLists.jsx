        ...
        <ScaleDecorator>
            ...
            >
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <View style={{ backgroundColor: '#F2F0F8', height: 48, width: 48 }}></View>
                    <Text style={{ fontSize: 14, color: 'black', marginHorizontal: 5 }}>
                        {item?.title}
                    </Text>
                </View>
    ...
    return (
        <Background>
            ...
            >
                ...
                >
                    <View>
                        <Text style={{ fontFamily: 'Lora-Bold', fontSize: 16 }}>
                            Re-arrange tasks
                        </Text>
                        <Text style={{ fontFamily: 'Mulish-Regular', fontSize: 12 }}>
                            Long press & hold tracks to move them up or down
                        </Text>
                    </View>
