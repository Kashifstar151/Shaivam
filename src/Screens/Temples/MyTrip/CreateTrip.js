...
const CreateTrip = ({ navigation }) => {
    const data = [
        { name: 'Jyotirlinga/Thirumurai Temples', color: '#E62828' },
        ...
        <View style={{ flex: 1 }}>
            <ScrollView style={{ flex: 1 }}>
                    ...
                    <View style={styles.mainCom}>
                        <View>
                            ...
                            <Text style={styles.subHeadingText}>
                                Follow these steps and make a trip
                            </Text>
                        </View>
                ...
                <View style={styles.containers}>
                    ...
                    >
                        Enter your starting point & end point
                    </Text>
                    <Text style={{ marginTop: 10, fontFamily: 'Mulish', lineHeight: 17 }}>
                        In the absence of an end point, we will suggest 20 Temples around your
                        starting point
                    </Text>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View style={{ paddingHorizontal: 20 }}>
                            <TextInputCom
                                navigation={() => navigation.navigate(RouteTexts.TEMPLE_SELECTION)}
                                headinText={'Starting Location*'}
                                insiderText={'Current Location'}
                            />
                ...
                <View style={styles.containers}>
                    ...
                    <Text style={{ marginTop: 10, fontFamily: 'Mulish', lineHeight: 17 }}>
                        Move the slider around and select temple search diameter
                    </Text>
                ...
                <View style={[styles.containers, { paddingBottom: 100, paddingTop: 20 }]}>
                    ...
                    <TextInputCom
                        headinText={'Trip name'}
                        insiderText={'Type here'}
