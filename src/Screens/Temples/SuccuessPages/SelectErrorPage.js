        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <View style={styles.mainContainer} >
                ...
                <View style={styles.inputContainer}>
                    ...
                    <TextInput onChangeText={(e) => setDescription(e)} placeholderTextColor={colors.grey5} placeholder="Type here" style={{ backgroundColor: '#F3F3F3', borderRadius: 10, padding: 10, height: 100 }} />
                </View>
                <View style={styles.inputContainer}>
                    <Text style={styles.descriptionText}>Your Phone number*</Text>
                    <TextInput onChangeText={(e) => setphoneNumber(e)} placeholderTextColor={colors.grey5} placeholder="Type here" style={{ backgroundColor: '#F3F3F3', borderRadius: 10, padding: 10, height: 50 }} />
                </View>
