...
const TextInputCom = ({ headinText, insiderText, width, navigation, locationIcon, State, inputKey, value, height }) => {
    ...
    return (
        <View style={{ marginVertical: 10 }}>
            ...
            <View style={{ flexDirection: 'row', backgroundColor: '#F3F3F3', height: height ? height : 55, width: width ? width : Dimensions.get('window').width - 90, alignItems: 'center', paddingHorizontal: 20, borderRadius: 10, }}>
                ...
                <TextInput value={value} onChangeText={(e) => dispatch(setInputValue({ inputKey, inputValue: e }))} onFocus={navigation} style={{ paddingHorizontal: 10, }} placeholder={insiderText} />
