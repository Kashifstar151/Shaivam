                ...
                showTimer ?
                    <View style={{ paddingHorizontal: 10, flex: 1, borderTopRightRadius: 15, borderTopLeftRadius: 15, backgroundColor: '#fff' }}>
                        ...
                        <View style={{ marginVertical: 20 }}>
                            ...
                            <Text style={{ color: '#777777', fontSize: 12, fontFamily: 'Mulish-Regular' }}>This can be changed if required in the More options</Text>
                        </View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginVertical: 30, alignItems: 'center' }}>
                            <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center', borderColor: '#4C3600', borderWidth: 1, backgroundColor: '#F3DAA0', height: 50, width: 50, borderRadius: 15 }}>
                                <AntDesign name='minus' size={25} />
                            </TouchableOpacity>
                            <View style={{ alignItems: 'center' }}>
                                <Text style={{ fontSize: 32, fontFamily: 'Mulish-Bold' }}>15</Text>
                                <Text style={{ fontSize: 16, fontFamily: 'Mulish-Regular' }}>Minutes</Text>
                            </View>
                            <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center', borderColor: '#4C3600', borderWidth: 1, backgroundColor: '#F3DAA0', height: 50, width: 50, borderRadius: 15 }}>
...
export const styles = StyleSheet.create({
    ...
    topConatiner: { justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center', marginTop: 20 },
    errorContainer: {
